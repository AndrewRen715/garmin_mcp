#!/usr/bin/env python3
"""
为即将到来的越野赛制定训练计划，并为5月中的目标做准备（最终版：周六长距离，周四中高强度）
"""
import json
...
def create_race_prep_plan():
    ...
    # 调整第3-6周的长距离跑到周六
    # 第3周调整
    week3['daily_plan'][4]['type'] = '长距离跑'
    week3['daily_plan'][4]['distance'] = 12
    week3['daily_plan'][4]['description'] = '轻松长距离跑，75-90分钟'
    week3['daily_plan'][5]['type'] = '休息'
    week3['daily_plan'][5]['distance'] = 0
    week3['daily_plan'][5]['description'] = '完全休息'
    
    # 第4周调整
    week4['daily_plan'][3]['type'] = '长距离跑'
    week4['daily_plan'][3]['distance'] = 17
    week4['daily_plan'][3]['description'] = '长距离跑，90-120分钟'
    week4['daily_plan'][5]['type'] = '休息'
    week4['daily_plan'][5]['distance'] = 0
    week4['daily_plan'][5]['description'] = '完全休息'
    
    # 第5周调整
    week5['daily_plan'][3]['type'] = '长距离跑'
    week5['daily_plan'][3]['distance'] = 21
    week5['daily_plan'][3]['description'] = '长距离跑，120-150分钟'
    week5['daily_plan'][5]['type'] = '休息'
    week5['daily_plan'][5]['distance'] = 0
    week5['daily_plan'][5]['description'] = '完全休息'
    
    # 第6周调整
    week6['daily_plan'][3]['type'] = '长距离跑'
    week6['daily_plan'][3]['distance'] = 25
    week6['daily_plan'][3]['description'] = '长距离跑，150-180分钟'
    week6['daily_plan'][5]['type'] = '休息'
    week6['daily_plan'][5]['distance'] = 0
    week6['daily_plan'][5]['description'] = '完全休息'
...
def main():
    ...
    # 保存计划到JSON文件
    with open('race_prep_plan_final.json', 'w', encoding='utf-8') as f:
        json.dump(plan, f, indent=2, ensure_ascii=False)
    
    print("\n计划已保存到 race_prep_plan_final.json")
