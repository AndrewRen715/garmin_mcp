...
def main():
    ...
    # 保存计划到JSON文件
    with open('race_prep_and_recovery_plan.json', 'w', encoding='utf-8') as f:
        json.dump(plan, f, indent=2, ensure_ascii=False)
    
    print("\n计划已保存到 race_prep_and_recovery_plan.json")
